...
import { useCreateIssue } from '../../apis/issue/usePostCreateIssueDetail';
import { useGetIssueDetail } from '../../apis/issue/useGetIssueDetail';
import { useUpdateIssue } from '../../apis/issue/usePatchIssueDetail';
import { useIssueDeadlinePatch } from '../../hooks/useIssueDeadlinePatch.ts';
import type { CreateIssueDetailDto, UpdateIssueDetailDto } from '../../types/issue.ts';
...
const WorkspaceIssueDetail = ({ initialMode }: WorkspaceIssueDetailProps) => {
  ...
  const { handleSelectDateAndPatch, buildPatchForEditSubmit } = useIssueDeadlinePatch({
    issueDetail,
    isViewMode: isCompleted,
    canPatch,
    mutateUpdate: updateIssue,
  });
