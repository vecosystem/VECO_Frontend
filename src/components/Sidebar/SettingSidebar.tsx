      ...
      <div className="flex flex-col items-start gap-[3.2rem] self-stretch">
        ...
        <div className="flex flex-col items-start self-stretch">
          <DropdownMenu headerTitle="워크스페이스" initialOpen={true}>
            <div className="flex flex-col justify-center items-flex-start gap-[1.6rem] pb-[1.6rem]">
              <SidebarItem
                defaultIcon={<img src={vecocirclenavy} alt="Goal" />}
                label="워크스페이스 프로필"
                onClick={() => {
        ...
        <div className="flex flex-col items-start self-stretch">
          <DropdownMenu headerTitle="팀" initialOpen={true}>
            <div className="flex flex-col justify-center items-start gap-[1.6rem] pb-[1.6rem]">
              <SidebarItem
                defaultIcon={<img src={tableHoverIcon} alt="Goal" />}
                hoverIcon={<img src={tableHoverIcon} alt="Goal" />}
                label="팀 목록"
                onClick={() => {
              ...
              />
              <SidebarItem
                defaultIcon={<img src={usersIcon} alt="Issue" />}
                hoverIcon={<img src={usersHoverIcon} alt="Issue" />}
                label="워크스페이스 멤버"
                onClick={() => {
        ...
        <div className="flex flex-col items-start self-stretch">
          <DropdownMenu headerTitle="계정" initialOpen={true}>
            <div className="flex flex-col justify-center items-start gap-[1.6rem] pb-[1.6rem]">
              <SidebarItem
                defaultIcon={<img src={userProfileIcon} alt="Goal" />}
                hoverIcon={<img src={userProfileHoverIcon} alt="Goal" />}
                label="나의 프로필"
                onClick={() => {
